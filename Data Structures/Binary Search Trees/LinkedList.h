...
public:
	...
	// Use to check and see if a POTUS with the same Last Name exist
	bool PotusExistInList(string last)
	{
		auto index = 0;
		auto foundNode = false;
	...
	// Use to check and see if a POTUS is a list
